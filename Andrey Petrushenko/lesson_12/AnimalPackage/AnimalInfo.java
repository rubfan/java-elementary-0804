...
public abstract class AnimalInfo {
    // 1) Напишите программу которая выводит на экран информацию о животном
    // имя котрого введено с клавиатуры.
    //Постройте иерархию классов животных используйте абстакцию и наследование.
    //Вся информация о животном должна быть получена с помошью
    // полей и методов класса который ассоциируется с этим животным.
    ...
    //Постройте иерархию минимум на 5 уровней,желательно чтобы все
    // методы и поля которые повторяются должны выностится на уровень вверхпо иерархии,
    ...
    //3) Напишите метод который выводит всю иерархию подвидов животного.
    // (таким образом будет видна цепочка наследования)
